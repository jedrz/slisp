...
\subsection{Klasy implementujące metodę eval}

Wywołanie metody \verb+eval+ na~obiektach typu \verb+Num+, \verb+Str+,
\verb+Bool+, \verb+Nil+ zwraca sam obiekt.
...
Klasy, które implementują metodę interfejs \verb+Callable+,
to~\verb+Primitive+, \verb+SpecialForm+, \verb+Function+ oraz \verb+Macro+.
